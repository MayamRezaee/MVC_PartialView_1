...
namespace MVC_PartialView.Models.Repository
{
    public class PersonRepository
    {
        ...
        //This will create an object for the first time we call it
        ...
        //Filtering the list by the name
        public List<Person> FilterByName(string expToSearch)
        {
            return _people.Where(item => item.Name.ToLower() == expToSearch.ToLower()).ToList();
        }
