...
namespace MVC_PartialView.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpGet("deleteUser/{itemId}")]// URL path
        ...
        [HttpPost("user")] 
        public IActionResult AddPerson([FromForm]CreatePersonViewModel cpvm) {
            PersonRepository.GetIns().Create(cpvm.Name,cpvm.City,cpvm.PhoneNum);
            return View("Index", GetAllUsers());
        }
